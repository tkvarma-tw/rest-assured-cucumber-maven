...
public class E2E_Tests {
    public static void main(String[] args) {
        String userID = "dcf92261-73fa-499f-a6e9-d54bca47bcda";
        ...
        jsonString = response.asString();
        List<Map<String, String>> booksAdd = JsonPath.from(jsonString).get("books");
        Assert.assertTrue(booksAdd.size() > 0);

        //This bookId will be used in later requests, to add the book with respective isbn
        String isbnIdAdd = booksAdd.get(0).get("isbn");
        ...
        response = request.body("{ \"isbn\": \"" + isbnIdAdd + "\", \"userId\": \"" + userID + "\"}")
